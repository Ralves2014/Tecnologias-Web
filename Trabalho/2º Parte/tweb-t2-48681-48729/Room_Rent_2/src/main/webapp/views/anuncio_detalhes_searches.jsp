  ...
  <body>
    ...
    <script>
      ...
      $(document).ready(function () {
        $.post("/anuncio?"+ "&aid="+ localStorage.getItem("id_searchs"), function (data){
        ...
        document.getElementById("aid_escondido").value = localStorage.getItem("id_searchs");
        ...
        $.post("/mensagens?" + "&aid_a=" + localStorage.getItem("id_searchs"), function (data){
          if (data.length==0) {
