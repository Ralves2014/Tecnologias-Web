...
<html>
  ...
  <body>
    ...
    <script>
      ...
      function valida(){
          console.log(document.getElementById("rem").value);
      ...
      $(document).ready(function () {
        $.post("/anuncio?" + "&aid=" + localStorage.getItem("id_anuncio"), function (data){
        ...
        document.getElementById("aid_escondido").value = localStorage.getItem("id_anuncio");
        ...
        $.post("/mensagens?" + "&aid_a=" + localStorage.getItem("id_anuncio"), function (data){
